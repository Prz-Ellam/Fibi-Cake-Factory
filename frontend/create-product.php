...
<body>
    ...
    <section class="container my-4">
        <div class="row d-flex justify-content-center">
            <form class="bg-white shadow-sm rounded-1 p-5 col-lg-8 col-md-6" id="create-product-form">
                
                <h1 class="h2 text-center mb-4">Agregar producto</h1>
                ...
                <input class="btn btn-orange text-light shadow-none rounded-1 w-100 mt-3" type="submit" value="Registrar" id="submit">
            ...
            <div class="modal-content bg-white rounded-1 border-0 shadow-sm">
                <form id="create-category-form">
                    <div class="modal-header border-0">
                        <h5 class="modal-title" id="create-category-label">Agregar categoría</h5>
